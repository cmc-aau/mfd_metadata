...
entires.time <- tables.summ %>%
  filter(field%in%c("sampling_date", "latitude", "longitude", "sitename", "mfd_sampletype", "mfd_areatype", "mfd_hab1", "mfd_hab2", "mfd_hab3")) %>%
  pivot_longer(-field) %>%
...
entires.time
ggsave(paste0(releases.path, "/entires_time.png"), entires.time, width = 8, height = 3.75)
```
